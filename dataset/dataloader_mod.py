...
def RADIal_collate(batch):
    ...
    for radar_FFT, segmap,out_label,box_labels,image, seq_id in batch:
    ...
    return torch.stack(FFTs), torch.stack(encoded_label),torch.stack(segmaps),labels,torch.stack(images), seq_ids
